...
````
--------------------------
`<<` (ուղարկել) արտածման օպերատորին համապատասխան օգտագործվել է `>>` (ստանալ) ներմուծման օպերատորը, և `cin`֊ը ներմուծման ստանդարտ հոսքն է (Գլուխ 8)։ `>>` օպերատորի աջակողմյան օպերանդը որոշում է, թե ինչ է պետք ներմուծել և այդ աջակողմյան օպերանդը նշան է ներմուծման գործողության համար։ `\n` սիմվոլը արտածվող տողի վերջում ցույց է տալիս նոր տող (§1.3)։
