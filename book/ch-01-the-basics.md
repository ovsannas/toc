...
Ուշադրություն դարձնենք, թե ինչպես կարելի է ցուցիչը `++` գործողությամբ տեղափոխել զանգվածի հաջորդ տարրին, և թե ինչպես կարելի է բաց թողնել `for` հրամանի ինիցիալիզացիայի բլոկը, եթե դրա կարիքը չկա։
...
C++ լեզվում առկա են ճյուղավորման ու կրկնությունների կազմակերպման սովորական դարձած կառուցվածքները, ինչպիսիք են `if` հրամանը, `switch` հրամանը, `while` ցիկլը և `for` ցիկլը։ Օրինակ, ստորև սահմանված է ֆունկցիա, որն օգտագործողին մի հարց է տալիս և վերադարձնում է պատասխանն արտահայտող տրամաբանական արժեքը։
...
Ի համապատասխանություն `<<` (ուղարկել) օպերատորի՝ օգտագործվում է `>>` (ստանալ) ներմուծման օպերատորը. `cin`֊ը ներմուծման ստանդարտ հոսքն է (Գլուխ 10)։ `>>` օպերատորի աջակողմյան օպերանդը որոշում է, թե ինչպիսի ներմուծում է սպասվում, և նույն այդ աջակողմյան օպերանդը հենց ներմուծման գործողության նպատակակետն է։ Արտածվող տողի վերջին `\n` նիշը նոր տողին անցման նիշն է (§1.2.1)։
...
Օբյեկտի սկզբնական արժեքի ձևավորումը (initialization) տարբերվում է վերագրումից։ Ընդհանուր առմամբ, որպեսզի վերագրումը ճիշտ աշխատի, վերագրվող օբյեկտը պետք է արժեք ունենա։ ?? Մյուս կողմից, սկզբնական արժեքի ձևավորման՝ ինիցիալիզացիայի խնդիրը հիշողության չարժեքավորված հատվածում վավեր օբյեկտի ձևավորումն է։ Համարյա բոլոր տիպերի համար չարժեքավորված հիշողությունից կարդալը կամ այնտեղ գրելը անորոշ գործողություն է։ Ներդրված տիպերի համար դա ավելի ակնհայտ է հղումների դեպքում.
...
Հղմանը սկզբնական արժեք տալու համար կարող եք օգտագործել `=` գրառումը, բայց, խնդրում եմ, թող դա չշփոթեցնի ձեզ։ Օրինակ.
...
Ինիցիալիզացիայի և վերագրման միջև տարբերությունը էական է նաև օգտագործողի սահմանած տիպերի համար, ինչպիսիք են `string`-ը կամ `vector`-ը, որտեղ վերագրման ձախ օպերանդը տիրանում է ռեսուրսների, որոնք պետք է հանկարձակի ազատվեն (§5.3)։ ??

Արգումենտի փոխանցման և ֆունկցիայից արժեքի վերադարձման սեմանտիկան նույնական է ինիցիալիզացիայի հետ (§3.6)։ ?? Օրինակ, հենց այդպես ենք ստանում փոխանցում-ըստ-հղման գաղափարը։ ??
