...
*Կոնտեյները* օբյեկտ է, որը պահում է իր մեջ էլեմենտների խումբ, հետևաբար մենք `Vector`֊ ն անվանում ենք  կոնտեյներ, որովհետև վերջինս այն տիպի օբյեկտներից է, որոնք կոնտեյներներ են։ Ինչպես, որ սահմանված է §2.3֊ում, `Vector`֊ը `double`արժեքների անխոհեմ կոնտեյներ չէ․ սա շատ պարզ է հասկանալու համար, ստեղծում է օգտակար ինվարիանտ (§3.4.2), ապահովում է դիմում դիապազոնի ստուգմամբ(range-checked access)(§3.4.1) և տալիս է ֆունկցիա `size()`, մեզ՝ իր տարրերի վրայով անցնելը  թույլ տալու համար։ Այնուամենայնիվ, այն ունի ճակատագրական բացթողում․ նա տեղավորում է էլեմենտներն օգտագործելով `new` հրամանը, սակայն երբեք չի ազատում այդ դաշտերը։ Սա այնքան էլ լավ գաղափար չէ, քանի որ չնայած որ C++ լեզուն սահմանում է ինտերֆեյս աղբահավաքի (garbage collector) համար (§4.6.4), երաշխավորված չէ, որ ինչ֊որ մեկը հասանելի կլինի, որպեսզի չօգտագործվող հիշողությունը դարձնի հասանելի նոր օբյեկտների համար։ Որոշ միջավայրերում դուք չեք կարող օգտագործել աղբահավաքը, և երբեմն դու նախընտրում ես ավելի ճշգրիտ հսկողություն դեստրուկցիայի համար՝ ելնելով տրամաբանական կամ էֆեկտիվության պատճառներից։ Այդ պատճառով մեզ անհրաժեշտ է մի մեխանիզմ, որը կհավաստիացնի, որ կոնստրուկտորի կողմից առանձնացված հիշողությունը, ազատված է; այդ մեխանիզմը *դեստրուկտորն է*․
