...
«Օգտագործողի սահմանած դասական թվաբանական տիպը» `complex` տիպն է․
...
````
Սա ստանդարտ-գրադարանի `complex` տիպի թեթևակի պարզեցրած տարբերակն է (§12.4)։ Դասի սահմանումը պարունակում է միայն այն գործողությունները, որոնք պահանջում են մուտք ներկայացման մեջ։ Ներկայացումը պարզ է և սովորական։ Պրակտիկ պատճառներով այն պետք է համատեղելի լինի այն ամենի հետ, ինչ որ Ֆորտրանն է առաջարկել 50 տարի առաջ և մեզ անհրաժեշտ է օպերատորների պայմանական խումբ։ Տրամաբանական պահանջներին գումարած `complex`֊ը պետք է լինի էֆեկտիվ կամ էլ այն կմնա չօգտագործված։ Սա ենթադրում է, որ պարզ գործողությունները պետք է լինեն ներսում։ Սա նշանակում է, որ պարզ գործողությունները (այնպիսիք, ինչպիսիք են օրինակ կոնստրուկտորները, `+=`, և `imag()`) պետք է իրականացված լինեն առանց ֆունկցիաների կանչերի ստեղծված մեքենայական կոդում։ Այն ֆունկցիաները, որոնք սահմանված են դասի մեջ ներկառուցված են լռությամբ։ Հնարավոր է բացահայտորեն պահանջել ներկառուցում՝ ֆունկցիայի հայտարարության առջևից  դնելով `inline` բառը։ An industrial-strength `complex` (ինչպիսին ստանդարտ գրադարանինն է) զգուշորեն իրականացված է կատարելու համար համապատասխան ներկառուցում։
