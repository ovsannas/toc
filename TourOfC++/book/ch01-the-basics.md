...
_Հայտարարությունը_ ծրագրում փոփոխականի անուն ներմուծող հրաման է։ Այն նշում է անվանված օբյեկտի տիպը․ ??

* _Տիպը_ սահմանում է (որոշում է) հնարավոր արժեքների և գործողությունների բազմությունը (ցանկացած օբյեկտի համար)։ ??
* _Օբյեկտը_ հիշողության մի մաս է, որը պարունակում է որևէ տիպի արժեք։ ??
* _Արժեքը_ բիթերի խումբ է՝ թարգմանված տիպին համապատասխան։ ??
* _Փոփոխականը_ անվանված օբեկտն է (այն օբյեկտն է, որն ունի անուն)։ ??

C++ լեզուն տրամադրում է մի քանի հիմնական տիպեր։ Օրինակ․
...
##1.6 Անվան տեսանելիության տիրույթ և կյանքի տևողություն

Հայտարարությամբ նոր անուն է ներմուծվում տեսանելիության տիրույթում․

* _Լոկալ տեսանելիություն_։ Ֆունկցիայում (§1.4) կամ լյամբդայում (§5.5) հայտարարված անունը կոչվում է _լոկալ անուն_։ Նրա տեսանելիության տիրույթը տարածվում է նրա հայտարարության կետից մինչև այն բլոկի վերջը, որտեղ գործում է այդ հայտարարությունը։ _Բլոկը_ սահմանափակված է մեկ զույգ `{}` ձևավոր փակագծերի միջև։ Ֆունկցիայի արգումենտների անունները նույնպես համարվում են լոկալ անուններ։
* _Դասի տեսանելիություն_։ Անունը կոչվում է _անդամի անուն_ (կամ _դասի անդամի անուն_), եթե այն սահմանվել է դասի մեջ (§2.2, §2.3, գլուխ 4)՝ որևէ ֆունկցիայից (§1.4), լյամբդայից (§5.5) կամ `enum class`-ից (§2.5) դուրս։ Նրա տեսանելիության տիրույթը տարածվում է իր հայտարարությունն ընդգրկող բլոկի բացող փակագծից մինչև այդ հայտարարության վերջը։
* _Անունների տիրույթի տեսանելիություն_։ Անունը կոչվում է _անվանատարածքի անդամի անուն_, եթե այն սահմանվել է անունների տիրությում (§3.3)՝ ցանկացած ֆունկցիայից, lambda֊ից (§5.5), դասից (§2.2, §2.3, գլուխ 4) կամ `enum class`֊ից դուրս (§2.5)։ Նրա տեսանելիության տարածվում է նրա հայտարարության կետից մինչև այդ անվանատարածքի վերջը։ 

Որևէ կառուցվածքից դուրս հայտարարված անունը կոչվում է _գլոբալ անուն_, և համարվում է, որ այն գտնվում է _անունների գլոբալ տիրույթում_։

Ի լրումն ասվածի՝ կարող ենք ունենալ անանուն օբյեկտներ, ինչպիսիք են ժամանակավոր և `new` օպերատորով ստեղծված օբյեկտները (§4.2.2): Օրինակ․

````c++
vector<int> vec; // vec-ը գլոբալ անուն է (ամբողջ թվերի գլոբալ վեկտոր)
struct Record {
    string name; // name-ը անդամ է (string տիպի անդամ)
//...
};
                  ...
                  // arg֊ը լոկալ անուն է (ամբողջ տիպի արգումենտ)
{
    ...
    auto p = new Record{"Hume"}; // p֊ն անանուն Record֊ի ցուցիչ է (որն ստեղծվել է new֊ով)
}
````

Օբյեկտը պետք է կառուցվի (ստանա սկզբնական արժեք) մինչև օգտագործումը և պետք է destroyed ?? իր տեսանելիության տիրույթի վերջում։ Անվանատարածքի օբյեկտի համար destruction point ?? ծրագրի վերջն է։ Անդամի համար destruction point-ը ?? այն օբյեկտի destruction point-ն ?? է, որի անդամն է տվյալ անունը։ `new`֊ով ստեղծված օբյեկտներն «ապրում են» մինչև `delete` (§4.2.2) գործողությամբ ջնջվելը։
