...
`std::` նախդիրը ցույց է տալիս, որ `cout` անունը գտնվում է ստանդարտ գրադարանի անունների տիրույթում (§3.3)։ Ստանդարտ գրադարանի հնարավորությունները քննարկելիս ես սովորաբար բաց եմ թողնում `std::`-ն։ §3.3 բաժնում ցույց է տրվում, թե ինչպես մի որևէ անունների տիրույթի անունները դարձնել տեսանելի՝ առանց անունների տիրույթը բացահայտ նշելու։
...
C++ լեզվով գրված ծրագրում  կատարված ինչ֊որ բան ստանալու համար հիմնական միջոցը այն ֆունկցիայի կանչելն է, որը դա անում է։ Ֆունկցիայի սահմանելը այն ճանապարհն է, որով մենք նկարագրում ենք, թե գործողությունը ինչպես պետք է կատարվի։ Ֆունկցիան հնարավոր չէ կանչել, եթե նախապես այն չի հայտարարվել։
...
Յուրաքանչյուր անուն և յուրաքանչյուր արտահայտություն ունի տիպ, վերջինս որոշում է այդ անվան կամ արտահայտության հետ կատարվող գործողությունները։ Օրինակ հետևյալ հայտարարությունը

````c++
   int inch;
````
նշում է, որ `inch` անունը `int` տիպի է; այսինքն `inch`֊ը ամբողջ տիպի փոփոխական է։
...
* _Արժեքը_ բիթերի խումբ է, որը թարգմանված է  իր տիպին համապատասխան։
* _Փոփոխականը_ անուն ունեցող օբյեկտն է։

C++ լեզուն առաջարկում է ֆունդամենտալ տիպերի բազմազանություն։ Օրինակ․

````c++
   bool           // տրամաբանական տիպ, հնարավոր արժեքներն են ճիշտ և սխալ
   char           // նիշ, օրինակ 'a', 'z', և '9'
...
Հաճախ իմաստ ունի ստուգել, որ ցուցիչի արգումենտը, որը ենթադրվում է, որ պետք է ցույց տա ինչ֊որ բանի վրա, իսկապես ցույց է տալիս ինչ֊որ բան․
