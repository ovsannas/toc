...
Հայտարարության մեջ `&` ունար սուֆիքսը նշանակում է «հղել»։ Հղումը նման է ցուցիչին, այն տարբերությամբ, որ կարիք չկա օգտագործել `*` նշանը այն արժեքին հասնելու համար, որի վրա ցույց է տալիս հղումը։ Հղումը սկզբնական արժեք ստանալուց հետո, այլևս չի կարող փոխվել՝ ուրիշ օբյեկտի վրա ցույց տալու համար։
