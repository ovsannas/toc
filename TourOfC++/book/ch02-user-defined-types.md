...
Ակնհայտ է, որ սխալների մշակումը բացակայում է ամբողջությամբ, բայց մենք կվերադառնանք դրան §3.4֊ում։ Նմանապես, մենք չենք ապահովում մեխանիզմ, որը «հետ կստանա» `double`ների զանգվածը `new`-ով ստացված ; §4.2.2֊ը ցույց է տալիս, թե ինչպես օգտագործել դեստրուկտորը՝ գեղեցիկ կերպով դա անելու համար։
